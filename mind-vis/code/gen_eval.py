...
if __name__ == '__main__':
    ...
    root = args.root
    target = args.dataset
    model_path = os.path.join(root, 'results/generation/07-05-2024-21-26-24/checkpoint_best.pth')
    ...
    config.pretrain_mbm_path = os.path.join(root, 'results/fmri_finetune/07-05-2024-21-14-30/checkpoints/checkpoint.pth')
