...
def main(config):
    ...
    if config.dataset == 'GOD':
        ...
        _, test_set = create_NOD_dataset(path=config.NOD_path, patch_size=config_pretrain.patch_size, 
                fmri_transform=torch.FloatTensor, subjects=config.NOD_subs, include_nonavg_test=config.include_nonavg_test)
    else:
        raise NotImplementedError

    print('test_set shape: ', test_set.fmri.shape)
